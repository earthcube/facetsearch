export default {
    ...
    NOTEBOOKS: [
        {
            name:'binder',
            baseurl:"https://mybinder.org/v2/gh/earthcube/NotebookTemplates.git/geocodes_template?urlpath=",
            dispatcherPage:"/notebooks/template.ipynb",
