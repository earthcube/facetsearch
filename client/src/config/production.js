export default {
  ...
  TRIPLESTORE_URL:
    ...
    "https://graph.geodex.org/blazegraph/namespace/earthcube/sparql", // dev
  ...
  //ECRR_TRIPLESTORE_URL:'https://graph.geodex.org/blazegraph/namespace/ecrr/sparql',// prod
  ...
  ECRR_GRAPH:
    process.env.VUE_APP_ECRR_GRAPH || "http://earthcube.org/gleaner-summoned", //fuskei
  ...
  JSONLD_PROXY:
    process.env.VUE_APP_JSONLD_PROXY || "${window.location.origin}/ec/api/${o}",
