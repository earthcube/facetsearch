export default {
  ...
  API_URL:
    ...
    `https://alpha.geocodes.earthcube.org/ec/api`,
  ...
  TRIPLESTORE_URL:
    ...
    "https://graph.geodex.org/blazegraph/namespace/earthcube/sparql",
  ...
  JSONLD_PROXY:
    ...
    "https://alpha.geocodes.earthcube.org/ec/api/dataset/${o}",
