export default {
  ...
  API_URL:
    ...
    `https://geocodes.geocodes-dev.earthcube.org/ec/api`,
  ...
  TRIPLESTORE_URL:
    process.env.VUE_APP_TRIPLESTORE_URL ||
    "https://graph..geocodes-dev.earthcube.org/blazegraph/namespace/earthcube/sparql",
  //ECRR_TRIPLESTORE_URL:'https://graph.geocodes.earthcube.org/blazegraph/namespace/ecrr/sparql',// dev
  ECRR_TRIPLESTORE_URL:
    process.env.VUE_APP_ECRR_TRIPLESTORE_URL ||
    "http://132.249.238.169:8080/fuseki/ecrr/query", // fuseki
  ECRR_GRAPH:
    process.env.VUE_APP_ECRR_GRAPH || "http://earthcube.org/gleaner-summoned",
  ...
  JSONLD_PROXY:
    process.env.VUE_APP_JSONLD_PROXY ||
    "https://geocodes.geocodes-dev.earthcube.org/ec/api/dataset/${o}",
  SPARQL_NB: "https://geocodes.geocodes-dev.earthcube.org/notebook/mkQ?q=${q}",
  ...
  COLLECTION_FACETS: [
    {
      ...
      items: [
        { id: "data", count: 0, isActive: false, name: "data" },
  ...
  NOTEBOOKS: [
    {
      ...
      baseurl:
        "https://mybinder.org/v2/gh/earthcube/NotebookTemplates.git/geocodes_template",
      binderEncodeParameters: true,
      dispatcherPage: "urlpath=notebooks/template.ipynb",

      contentQuery:
        'dataset={"contenturl":"${contentUrl}","encoding":"${format}","urn":"${urn}"}',
    ...
    },
    {
      ...
      contentQuery:
        "url=${contentUrl}&ext=${format}&urn=${urn}&encoding=${format}",
      pageTemplate: "",
      formats: ["*"],
    },
    {
      ...
      badge:
        "https://camo.githubusercontent.com/84f0493939e0c4de4e6dbe113251b4bfb5353e57134ffd9fcab6b8714514d4d1/68747470733a2f2f636f6c61622e72657365617263682e676f6f676c652e636f6d2f6173736574732f636f6c61622d62616467652e737667",
      baseurl: "https://geocodes.geocodes-dev.earthcube.org/notebook/mknb",
      binderEncodeParameters: false,
      contentQuery:
        "url=${contentUrl}&ext=${format}&urn=${urn}&encoding=${format}",
      pageTemplate: "",
