<template>
  <div class="feedback">
    ...
    <b-button v-b-modal.feedback-modal variant="primary" @click="showModal"
    ...
    <b-modal
      ...
      @ok="handleOk"
    >
      <template #modal-title> Create New Collection: </template>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.$store.commit("setNewCollection", {
        key: this.name,
        value: this.name,
      });
