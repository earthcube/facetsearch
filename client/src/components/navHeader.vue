<template>
    <b-navbar toggleable="lg" type="dark" variant="primary" sticky>
        ...
        <b-container fluid="md">
            ...
            <b-navbar-brand href="https://www.earthcube.org/geocodes" target="_blank" class="mr-0"><logoEarthcube width="120px" /></b-navbar-brand>
                ...
                <b-nav-form v-on:submit.prevent="onSubmitNavbar" v-show="$route.name.toLowerCase() != 'landing'">
                    <b-input-group size="sm">
                        ...
                        <b-input-group-append>
                            <b-button type="submit" variant="secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
