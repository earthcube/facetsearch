<template>
    <div class="buttons">
      <b-button-group v-for="(d, index) in mapping.s_downloads"
                      v-bind:key="index">
        ...
        <b-button-group vertical class="ml-1">
          ...
          >Open in</b-button>
                  <b-button  size="sm" variant="primary"
                            ...
                            v-bind:href="nbBinderUrl(d.contentUrl,d.encodingFormat,d)"
                             target="_blank"
                  >
...
export default {
 ...
 //   this.toMetadata();
  ...
  methods: {
    nbBinderUrl(contentUrl,format,urn){
